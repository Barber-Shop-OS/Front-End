    ...
    <div className="min-h-screen w-full bg-white">
      <header className="sticky top-0 z-50 flex w-full items-center justify-between border-b border-slate-100 bg-white/90 px-6 py-4 backdrop-blur lg:px-12">
        ...
        <nav className="hidden items-center gap-6 text-sm font-medium text-slate-500 md:flex">
          <a href="#beneficios" className="transition-colors hover:text-slate-900">Benefícios</a>
          <a href="#planos" className="transition-colors hover:text-slate-900">Planos</a>
          <a href="#depoimentos" className="transition-colors hover:text-slate-900">Depoimentos</a>
        </nav>
