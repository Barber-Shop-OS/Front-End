...
const AppointmentHeader = (): JSX.Element => (
...
const AppointmentSpecialistCard = (): JSX.Element => (
...
const AppointmentServiceCard = (): JSX.Element => (
  <div>
    <p className="text-sm font-bold uppercase tracking-[0.2em] text-slate-500">
      Serviço agendado
    </p>
...
const AppointmentLocationCard = (): JSX.Element => (
  <section>
    <h3 className="text-2xl font-bold uppercase tracking-[0.06em] text-slate-600">
      Localização
    </h3>
    <div className="mt-5 flex items-start gap-4">
      ...
      <div>
        ...
        <button
          type="button"
          className="mt-4 flex items-center gap-2 font-semibold text-[#0b4bd8]"
        >
...
const AppointmentActionsCard = (): JSX.Element => (
...
const MobileActionBar = (): JSX.Element => (
  <div className="flex gap-3 md:hidden">
    <button
      type="button"
      className="flex-1 rounded-xl bg-[#0b4bd8] px-4 py-3 font-semibold text-white"
    >
      Reagendar
    </button>
    <button
      type="button"
      className="flex-1 rounded-xl bg-white px-4 py-3 font-semibold text-red-600"
    >
      Cancelar
    </button>
  </div>
  ...
  return (
    <CustomerLayout>
      <div className="mx-auto max-w-4xl space-y-10 pb-10">
        <AppointmentHeader />
        <AppointmentStatusCard appointmentId={appointmentId} />

        <section className="grid gap-10 md:grid-cols-2">
          <AppointmentSpecialistCard />
