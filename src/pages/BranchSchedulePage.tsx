...
const items = [
  ["09:00", "Lucas Moura", "Corte Degrade + Barba", "CONFIRMADO", "45 min", "Ricardo S."],
  ["10:15", "Marcelo Vieira", "Corte Classico", "FINALIZADO", "", "Thiago B."],
  ["11:30", "Bruno Costa", "Coloracao Global", "PENDENTE", "90 min", "Ricardo S."],
];
      ...
      {items.map((item, index) => (
        <div
          ...
          className={`rounded-3xl bg-white p-5 shadow-sm ${
            index === 2 ? "border-l-4 border-[#d35400]" : index === 0 ? "border-l-4 border-[#0b4bd8]" : "opacity-75"
          }`}
        >
          <div className="grid grid-cols-[120px_1fr_auto] items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <div className="text-xl font-bold text-slate-900">{item[1]}</div>
