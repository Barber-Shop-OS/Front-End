...
const GreetingHeader = (): JSX.Element => (
  <div>
    ...
    <p className="mt-2 text-lg text-slate-600">O que vamos alinhar hoje?</p>
  </div>
);

const ReservationsSection = (): JSX.Element => (
  <div>
    <div className="mb-4 flex items-end justify-between">
      <div>
        <h2 className="text-2xl font-bold">Minhas Próximas Reservas</h2>
    ...
    <div className="grid gap-4 xl:grid-cols-2">
      <div className="rounded-2xl bg-white p-6 shadow-sm">
        ...
        <div className="mt-2 flex items-start justify-between gap-4">
          <div>
            <h3 className="text-xl font-bold">Corte Degradê + Barba</h3>
            <div className="mt-4 flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-semibold">Barbearia Vintage Club</p>
                <p className="text-sm text-slate-500">
...
const NearbySection = (): JSX.Element => (
  <div>
    <div className="mb-4 flex items-end justify-between">
      <div>
      ...
      <div className="flex gap-2">
        {["Todas", "Até 2km", "Corte Moderno", "Navalha"].map((chip, index) => (
          <button
            key={chip}
            type="button"
            ...
            <div>
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-500">{shop.distance}</p>
                </div>
...
const LoyaltyPromoCard = (): JSX.Element => (
...
const BookingPromoCard = (): JSX.Element => (
  <div className="rounded-3xl bg-[radial-gradient(circle_at_top_right,_#edf2ff_0%,_#dbe6ff_100%)] p-6">
    <h3 className="text-3xl font-black text-[#0b4bd8]">Espaço para mais um?</h3>
    <p className="mt-3 max-w-xs text-slate-600">
      Mantenha seu estilo impecável agendando sua próxima visita agora mesmo.
    </p>
    <button
      type="button"
